...
The second version, FMI 2.0, was published in 2014.
...
As of today, development of the standard continues through the participation of numerous companies and research institutes.
FMI 1.0 and FMI 2.0 are supported by over 45 tools and are used by automotive and non-automotive organizations throughout Europe, Asia and North America.
...
This version 3.0 is a major enhancement to FMI 2.0,
that incorporates many improvements,
often due to practical experience when using the FMI 2.0 standard.
