...
. The subinterval length latexmath:[hc_i] is the communication step size of the latexmath:[i^{th}] communication step, latexmath:[hc_i = tc_{i+1} - tc_i]. The communication step size has to be greater than zero.
...
_[Function `fmi3Set{VariableType}` used in the document, is an abbreviation for functions `fmi3SetFloat64`, `fmi3SetFloat32`, `fmi3SetInt64`,  `fmi3SetInt32`,  `fmi3SetInt16`, `fmi3SetInt8`, `fmi3SetUInt64`,  `fmi3SetUInt32`,  `fmi3SetUInt16`, , `fmi3SetUInt8`, `fmi3SetBoolean`, `fmi3SetString` and for other base variable types respectively - with the exception of clocks.
Function `fmi3Get{VariableType}` is an abbreviation for functions  `fmi3GetFloat64`, `fmi3GetFloat32`, `fmi3GetInt64`,  `fmi3GetInt32`,  `fmi3GetInt16`, `fmi3GetInt8`, `fmi3GetUInt64`,  `fmi3GetUInt32`,  `fmi3GetUInt16`, , `fmi3GetUInt8`, `fmi3GetBoolean`, `fmi3GetString` and for other base variable types respectively - with the exception of clocks.
]_
...
2. *Intermediate input variables for an FMU are available in the co-simulation
