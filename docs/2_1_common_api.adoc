...
- Argument `unknowns` contains the `valueReference`pass:[s] of the unknown variables. The number of `valueReference`pass:[s] is given by the argument `nUnknowns`.
-	Argument `knowns` contains the `valueReference`pass:[s] of the known variables. The number of `valueReference`pass:[s] is given by the argument `nKnowns`.
...
- Argument `nDeltaKnowns` provides the number of values in `deltaKnowns` which is only equal to `nKnowns` if all `valueReference`pass:[s] of `knowns` point to variables.
- Argument `nDeltaUnknowns` provides the number of values in `deltaUnknowns` which is only equal to `nUnknowns` if all `valueReference`pass:[s] of `unknowns` point to variables.
