...
Argument `valueReferences` is a vector of value references that define the variables whose derivatives shall be set.
The array `orders` contains the orders of the respective derivatives (1 means the first derivative, 0 is not allowed).
Argument `values` is a vector with the values of the derivatives.
`nValueReferences` is the dimension of the three vectors. +
...
Argument `valueReferences` is a vector of value references that define the variables whose derivatives shall be retrieved.
The array `orders` contains the order of the respective derivatives (1 means the first derivative, 0 is not allowed).
Argument `values` is a vector with the actual values of the derivatives.
`nValueReferences` is the dimension of the three vectors. +
