...
* Multiple model rates (periodic, variable/triggerable) in FMUs,
* Access to intermediate values of FMU variables between two communication points.
...
- e.g. if the FMU cannot provide an emulation of input clock tick occurrences -
