...
Also note the combination of `canNotUseBasicCoSimulation = true`, `providesHybridCoSimulation = false`, and `providesScheduledExecutionSimulation = false` is not possible.
